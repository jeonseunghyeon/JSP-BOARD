	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<%
						CategoryHiphopDAO CategoryBalladeDAO = new CategoryHiphopDAO();
						ArrayList<CategoryHiphopBean> list= CategoryHiphopDAO.getList(pageNumber);
			...
			<%
				}if(CategoryHiphopDAO.nextPage(pageNumber + 1)){
			%>
				<a href="board.jsp?pageNumber=<%=pageNumber + 1 %>"
