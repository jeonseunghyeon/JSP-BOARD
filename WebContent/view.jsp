...
%>
<title><%= boardbean.getBoardTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></title>
</head>
<body>
	...
	<nav class="navbar navbar-default"> <!-- 네비게이션 -->
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><li class="active"><a href="board.jsp">자유 게시판</a></li>
	...
	<div class="container">
		<div class="row">
			<table class="table table" style="text-align: center; border: 1px solid #dddddd">
				...
				<%
					if(u_ID != null && u_ID.equals(boardbean.getUserID())){
